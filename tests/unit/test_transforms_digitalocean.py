...
class TestDigitalOceanTransform:
    def test_digitalocean_transform_csv(self, cipr) -> None:
        """Test DigitalOcean CSV transform with real sample data."""
